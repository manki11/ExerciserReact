define(["../../webL10n",
    ...
    "../env",
    "../datastore",
    "../graphics/journalchooser",
    "../presence",
    "../graphics/icon",
    "../graphics/activitypalette"], function (
    l10n, shortcut, bus, env, datastore, chooser, presence, icon, activitypalette) {
