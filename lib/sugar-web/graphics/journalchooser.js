...
define(['picomodal','../datastore','./icon','mustache', '../env'], function(picoModal, datastore, icon, mustache, env) {
	...
	chooser.show = function(callback, filter1, orFilter2, orFilter3, orFilter4) {
		...
		modal = picoModal({
			content: doLocalize("\
				...
				<div class='toolbar' style='border-top-style: solid; border-color: #c0c0c0; border-width: 1px; margin-top: 55px'>\
				...
				<div id='journal-container' style='width: 100%; overflow:auto; margin-top: 110px'></div>"),
			closeButton: false,
			modalStyles: {
